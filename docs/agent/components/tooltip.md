...
Non-applicable states: Active, Loading, Error, Success. Use child components or the surrounding region for those states when needed.
...
- Component source: [packages/react/src/components/tooltip.tsx](../../../packages/react/src/components/tooltip.tsx)
