...
Non-applicable states: Hover, Focus-visible, Active, Disabled. Use child components or the surrounding region for those states when needed.
...
- Component source: [packages/react/src/components/avatar.tsx](../../../packages/react/src/components/avatar.tsx)
