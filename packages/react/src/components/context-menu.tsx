...
>(function ContextMenuContent(
  { className, collisionPadding = 16, ...props },
  ref
) {
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        ref={ref}
        className={cn("pds-context-menu-content", className)}
...
>(function ContextMenuItem(
  ...
  return (
    <ContextMenuPrimitive.Item
      ref={ref}
      className={cn("pds-context-menu-item", className)}
...
>(function ContextMenuCheckboxItem(
  ...
  return (
    ...
    >
      <span
        className="pds-context-menu-item-indicator"
        data-slot="context-menu-item-indicator"
      >
        <ContextMenuPrimitive.ItemIndicator>
          <span aria-hidden="true" className="pds-context-menu-check" />
        </ContextMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </ContextMenuPrimitive.CheckboxItem>
...
>(function ContextMenuRadioItem(
  ...
  return (
    ...
    >
      ...
      >
        <ContextMenuPrimitive.ItemIndicator>
          <span aria-hidden="true" className="pds-context-menu-radio-dot" />
        </ContextMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </ContextMenuPrimitive.RadioItem>
...
>(function ContextMenuLabel({ className, ...props }, ref) {
  return (
    <ContextMenuPrimitive.Label
      ref={ref}
      className={cn("pds-context-menu-label", className)}
...
>(function ContextMenuSeparator({ className, ...props }, ref) {
  return (
    <ContextMenuPrimitive.Separator
      ref={ref}
      className={cn("pds-context-menu-separator", className)}
...
>(function ContextMenuShortcut({ className, ...props }, ref) {
  return (
    <span
      ref={ref}
      className={cn("pds-context-menu-shortcut", className)}
...
>(function ContextMenuSubTrigger({ children, className, ...props }, ref) {
  return (
    ...
    >
      {children}
      <span aria-hidden="true" className="pds-context-menu-sub-chevron" />
    </ContextMenuPrimitive.SubTrigger>
  );
});
